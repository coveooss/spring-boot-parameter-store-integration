...
{
    private static final String SSM_CLIENT = "ssm-client";
    private static final String PROPERTY_SOURCE_PREFIX = "aws-parameter-store-property-source";
    private static final String SOURCE_PREFIX = "aws-parameter-store-source";
    ...
    public static final String ACCEPTED_PROFILES = joinWithDot(PROPERTY_SOURCE_PREFIX, "enabled-profiles");
    public static final String HALT_BOOT = joinWithDot(PROPERTY_SOURCE_PREFIX, "halt-boot");
    ...
    public static final String MULTI_REGION_SSM_CLIENT_REGIONS = joinWithDot(SOURCE_PREFIX,
                                                                             ...
                                                                             SSM_CLIENT,
                                                                             "regions");
    public static final String MAX_ERROR_RETRY = joinWithDot(SOURCE_PREFIX, SSM_CLIENT, "max-error-retry");
